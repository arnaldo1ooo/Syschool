 ...
 */
public class ReporteAlumnos extends javax.swing.JDialog {
    ...
    static org.apache.log4j.Logger log_historial = org.apache.log4j.Logger.getLogger(ReporteAlumnos.class.getName());

    public ReporteAlumnos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void ConsultaListadoAlumnos() {
        ...
        //Obtener docente
        try {
            con = con.ObtenerRSSentencia("SELECT CONCAT(fun_nombre,' ', fun_apellido) AS docente "
                    + "FROM nivel_docente, funcionario "
                    + "WHERE fun_codigo = nivfun_docente AND nivfun_nivel = '" + metodoscombo.ObtenerIDSelectCombo(cbNivel) + "' AND nivfun_periodo = '" + dyAnho.getYear() + "'");
            ...
            //Obtener tipo nivel
            con = con.ObtenerRSSentencia("SELECT niv_tipo FROM nivel WHERE niv_codigo = '" + metodoscombo.ObtenerIDSelectCombo(cbNivel) + "'");
            if (con.getResultSet().next()) {
                lblTipoNivel.setText(con.getResultSet().getString(1));
            } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                ReporteAlumnos dialog = new ReporteAlumnos(new javax.swing.JFrame(), true);
