...
public class ReporteGastos extends javax.swing.JDialog {
    ...
    DAO con = new DAO();
    DefaultTableModel modelTableGastos;
    static org.apache.log4j.Logger log_historial = org.apache.log4j.Logger.getLogger(ReporteGastos.class.getName());
    ...
    private void CargarComboBoxes() {
        ...
        metodoscombo.CargarComboConsulta(cbConcepto, "SELECT congas_codigo, congas_descripcion FROM concepto_gasto ORDER BY congas_descripcion", 1);
    ...
    private void ConsultaGastos() {
        modelTableGastos = (DefaultTableModel) tbPrincipal.getModel();//Cargamos campos de jtable al modeltable
        modelTableGastos.setRowCount(0); //Vacia la tabla
        ...
        if (cbConcepto.getSelectedItem().toString().equals("TODOS")) {
            sentencia = "CALL SP_ReporteGastos('" + formatofecha.format(dcDesde.getDate()) + "','" + formatofecha.format(dcHasta.getDate()) + "','-1')";
        } else {
            sentencia = "CALL SP_ReporteGastos('" + formatofecha.format(dcDesde.getDate()) + "','" + formatofecha.format(dcHasta.getDate()) + "','"
        ...
        try {
            ...
            while (con.getResultSet().next()) {
                ...
                total = total + monto;
                modelTableGastos.addRow(new Object[]{concepto, monto, fecha, obs});
        ...
        tbPrincipal.setModel(modelTableGastos);
    ...
    private void initComponents() {
        ...
        labelMetric2.setText("REPORTE DE GASTOS");
        ...
        tbPrincipal.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Concepto", "Monto", "Fecha", "Observacion"
            }
        ) {
    ...
    private void btnGenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarReporteActionPerformed
        ...
        rutajasper = "/reportes/reporte_gastos.jasper";
    ...
    private void cbConceptoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbConceptoItemStateChanged
        modelTableGastos = (DefaultTableModel) tbPrincipal.getModel();
        modelTableGastos.setRowCount(0);
